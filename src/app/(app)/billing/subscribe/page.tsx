    ...
    <div className="p-4 sm:p-8 max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          {blocked
            ? "Invoicely needs an active subscription before you can create invoices and quotes. Pick a plan below to continue — you'll be sent to PayFast to complete payment securely."
